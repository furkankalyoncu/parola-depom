...
$("#default-search").on("keyup", function (e) {
  ...
  const filteredData = data.filter((d) =>
    d.platform.toLowerCase().includes(e.target.value.toLowerCase())
  );
  ...
  if (data.length > 0) {
    ...
    for (let i = 0; i < data.length; i++) {
                ...
                <div class="bg-white border border-white shadow-lg rounded-3xl p-4 m-4" style="width: 16rem;">
                    <div class="flex-none sm:flex">
                        <div class="flex-auto sm:ml-5 justify-evenly" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            <div class="items-center sm:mt-2">
                                <div class="items-center">
                                    <div class="flex justify-between">
                                        ...
                                        <div class="flex">
                                        <div class="pl-1" id="edit" name="edit_${data[i].id}" data-splitbee-event="Clicked Edit Data"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 cursor-pointer" fill="none" viewBox="0 0 28 28" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg></div>
                                    <div id="delete" name="delete_${data[i].id}" data-splitbee-event="Clicked Delete Data"><svg
                            ...
                            <div id="copy" name="copy_${data[i].id}_name" class="contents" data-splitbee-event="Copied Username">
                            ...
                            <div>
                                ...
                                <div id="copy" name="copy_${data[i].id}_password" class="contents" data-splitbee-event="Copied Password">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline-block cursor-pointer"
                                    fill="none" viewBox="0 -2 28 28" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
      ...
      if (data[i].url != "" && data[i].url != undefined) {
        raw += `
                                <div><h3 class="font-normal pt-3">URL  <div id="copy" name="copy_${data[i].id}_url" class="contents" data-splitbee-event="Copied URL">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline-block cursor-pointer"
                                    fill="none" viewBox="0 -2 28 28" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
